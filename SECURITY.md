...
To report a security vulnerability in **CollegeMS**, please contact the maintainer through one of the following channels:

- 👤 Maintainer Profile: [imanchalsingh](https://github.com/imanchalsingh)
...
- CollegeMS Repository: https://github.com/imanchalsingh/collegems
