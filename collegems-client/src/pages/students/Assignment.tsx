...
export default function Assignment() {
  ...
  const sortedAssignments = [...filteredAssignments].sort((a, b) => {
    ...
    const aSubmitted = a.submissions?.some((s: any) => 
      s.student?.toString() === userId
    );
    const bSubmitted = b.submissions?.some((s: any) => 
      s.student?.toString() === userId
    );
  ...
  const getStatusColor = (assignment: any) => {
    const userId = localStorage.getItem("userId");
    const submitted = assignment.submissions?.some((s: any) => 
      s.student?.toString() === userId
    );
    ...
    <div className="min-h-screen bg-gray-900 text-white p-4 md:p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">Manage and submit your course assignments</p>
        </div>
          ...
          <div className="bg-gray-800 rounded-xl p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="w-12 h-12 rounded-full bg-[#0a295e]/20 flex items-center justify-center">
                <svg className="w-6 h-6 text-[#0a295e]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {sortedAssignments.map((assignment) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Submission Info */}
                  {submitted && assignment.submissions?.find((s: any) => 
                    s.student?.toString() === userId
                  )?.submittedAt && (
                    <div className="mb-4 p-3 bg-green-500/10 rounded-lg">
                      <div className="flex items-center text-sm text-green-400">
                        ...
                        Submitted on {new Date(
                          assignment.submissions.find((s: any) => 
                            s.student?.toString() === userId
                          )?.submittedAt
